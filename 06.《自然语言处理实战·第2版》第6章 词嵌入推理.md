...
### 6.2.2 组合词嵌入(Combining word embeddings)
...
### 6.2.4 Word2Vec 创新 (Word2Vec innovation)
...
### 6.2.5 人工智能依赖于嵌入 (Artificial intelligence relies on embeddings)
...
![image](https://cdn.nlark.com/yuque/__latex/182fb6a268c0bf5b1f1f8b171a56099f.svg)
...
![image](https://cdn.nlark.com/yuque/__latex/7e35bee8409a7f43ddb9a55b9693c5b7.svg)
...
对于 ![image](https://cdn.nlark.com/yuque/__latex/df976ff7fcf17d60490267d18a1e3996.svg) 个输出节点中的每一个，Softmax 的输出值可用归一化指数函数计算：

:::color2
（公式 6.3 Softmax）

![image](https://cdn.nlark.com/yuque/__latex/3d778c78cbf5fe229d11210f26773095.svg)
...
![image](https://cdn.nlark.com/yuque/__latex/f2b6500fd7981110fd9454ca9e66ffa6.svg)
...
![image](https://cdn.nlark.com/yuque/__latex/824e12f131334ea4848fc1b9e06e41fc.svg)
...
若你的 LSA 主题向量矩阵规模为 ![image](https://cdn.nlark.com/yuque/__latex/c69f05eb9f9c1aa272827de2ad6baa9f.svg)，则 LSA 词向量就是该 LSA 矩阵的行向量。这些行向量与 Word2Vec 一样，用大约 200 到 300 个实数来表达词义。LSA 词-主题向量在寻找相关和无关词语方面，与 Word2Vec 向量一样有用。如同在 GloVe 讨论中所学，Word2Vec 向量也可通过与 LSA 相同的 SVD 算法生成，但 Word2Vec 通过在文档之间创建滑动窗口来更充分地利用相同数量的单词。借助这种方法，同一个单词在窗口滑动之前最多可被重复利用五次。
